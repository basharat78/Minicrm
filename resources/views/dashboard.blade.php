        ...
        <div class="col-md-4">
            <div class="card bg-primary text-white">
                <div class="card-body">
                    ...
                    <h2 class="card-title">{{ $totalClients }}</h2>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card bg-success text-white">
                <div class="card-body">
                    ...
                    <h2 class="card-title">{{ $monthClients }}</h2>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card bg-info text-white">
                <div class="card-body">
                    ...
                    <h2 class="card-title">{{ $weekClients }}</h2>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                @empty
                                <tr>
                                    <td colspan="4" class="text-center">No clients yet.</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
